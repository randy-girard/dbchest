...
class Node < ApplicationRecord
  ...
  # Generate SSH keys, root password, and metrics API key on creation
  ...
  def metrics_collection_url
    Rails.application.routes.url_helpers.node_metrics_url(self, host: Rails.application.config.action_mailer.default_url_options[:host])
  end
